...
public static class Varint
{
    ...
    public static ulong Read(ReadOnlySpan<byte> bytes, ref int at)
    {
        ...
        for (var index = 0; index < MaxLength; index++)
        {
            ...
            {
                throw new FjordProtocolException("varint is truncated");
            }
            ...
            {
                throw new FjordProtocolException("varint overflows 64 bits");
            }
            ...
            if ((b & 0x80) == 0)
            {
                ...
                {
                    throw new FjordProtocolException("varint is not minimally encoded");
                }
