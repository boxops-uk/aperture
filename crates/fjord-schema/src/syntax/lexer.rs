...
//!
//! Its own lexer rather than a share of `sigla`'s, and the reason is the dependency
//! direction rather than taste: `sigla`'s lexer lives in `fjord-engine`, which sits
...
//!
//! A schema distinguishes what a name *is* by how it is written, exactly as `sigla`
